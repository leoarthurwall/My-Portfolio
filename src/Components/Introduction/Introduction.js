    ...
    return (
      <div main className='intro-container'>
            ...
            <div className='intro-main-text'>
              ...
              <p className='intro-main-text-summary'> I'm a <em>full stack developer</em> & <em>UX designer</em>. I love solving problems, expressing my creative side, and collaborating with people.</p>
