...
function ProjectsSection() {
  return (
    <div className="projects-section-container">
      ...
      <a className="project-summary-text-a" href="https://github.com/leoarthurwall" target="_blank" rel="noopener noreferrer">
        <p className="project-summary-text">
          Here is a selection of my work. If you're interested in seeing more of
          my work, feel free to head over to my{" "}
